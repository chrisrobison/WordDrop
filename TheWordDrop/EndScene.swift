...
protocol EndSceneDelegate {
    func endSceneDidFinish(myScene: EndScene, command:String)
}

class EndScene: SKScene {
    var thisDelegate: EndSceneDelegate?
    ...
    func buttonAction(sender:UIButton) {
        if sender.currentTitle=="Play Again" {
            ...
            self.thisDelegate!.endSceneDidFinish(self, command: "restart")
        }
    }
